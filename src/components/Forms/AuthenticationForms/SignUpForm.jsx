		...
		<>
            ...
            />
					...
					<textarea
						...
						cols="10"
						rows="10"
						className="bg-transparent w-full border border-[#525252] rounded-md focus:outline-none placeholder:text-sm text-white autofill:bg-transparent mt-5 p-2"></textarea>
					<input
						type="text"
						name="referral"
						id="referral"
