...
const Chats = () => {
  ...
  return (
    <div className="h-screen bg-neutral-900 text-white lg:flex">
      <div className="flex items-center justify-between bg-neutral-800 p-4 lg:hidden">
      ...
      <div className="h-[72vh] lg:h-auto lg:w-96">
        <ChatsSelect>
